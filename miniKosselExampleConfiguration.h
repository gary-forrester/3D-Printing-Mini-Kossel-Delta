...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 164.0 // mm  166
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 890 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define MANUAL_Z_HOME_POS 245.2 // Distance between the nozzle to printbed after homing
